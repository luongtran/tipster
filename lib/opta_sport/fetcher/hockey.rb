  ...
  module Fetcher
    class Hockey < Base
      AVAILABLE_FUNCTIONS = {
          ...
          #    'result_class' => OptaSport::FetchResult::Hockey::Area
          #},
          #'get_competitions' => {
          #    'required_params' => [],
          #    'options_params' => %w(area_id authorized),
          #    'result_class' => OptaSport::FetchResult::Hockey::Competition
          #},
          #'get_matches' => {
          #    'required_params' => %w(id type),
          #    'options_params' => %w(start_date end_date limit detailed last_updated),
          #    'result_class' => OptaSport::FetchResult::Hockey::Match
          #},
          #'get_seasons' => {
          #    'required_params' => %w(),
          #    'options_params' => %w(authorized coverage active id type last_updated),
          #    'result_class' => OptaSport::FetchResult::Hockey::Season
          #}
      }
