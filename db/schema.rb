...
ActiveRecord::Schema.define(version: 20140222075548) do
  ...
  create_table "subscriptions_tipsters", force: true do |t|
  ...
  add_index "subscriptions_tipsters", ["subscription_id"], name: "index_subscriptions_tipsters_on_subscription_id", using: :btree
  add_index "subscriptions_tipsters", ["tipster_id"], name: "index_subscriptions_tipsters_on_tipster_id", using: :btree
